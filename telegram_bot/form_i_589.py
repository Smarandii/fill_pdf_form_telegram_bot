...
class Form_I_589(StatesGroup):
    ...
    A_II_NotMarried_0_TextField10_2 = State()  # 56  # U_S_ Social Security Number\n(if any)
    ...
    A_II_NotMarried_0_TextField10_3 = State()  # 60 Other names used (include\nmaiden name and aliases)
    ...
    A_II_ChildSSN1_0 = State()  # 78 U_S_ Social Security Number\n(if any
    ...
    A_II_ChildSSN2_0 = State()  # 97  # U_S_ Social Security Number\n(if any)
    ...
    A_II_ChildSSN3_0 = State()  # 115  # U_S_ Social Security Number\n(if any)
    ...
    A_II_ChildSSN4_0 = State()  # 133 U_S_ Social Security Number\n(if any)
    ...
    A_III_DateTimeField21_0 = State()  # 152 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField20_0 = State()  # 153 To (Mo/Yr)

    A_III_TextField13_1 = State()  # 154  # Number and Street\n(Provide if available)
    ...
    A_III_DateTimeField22_0 = State()  # 158 Dates\nFrom (Mo/Yr)
    ...
    A_III_DateTimeField24_0 = State()  # 164  # Dates\nFrom (Mo/Yr)
    A_III_DateTimeField26_0 = State()  # 165  # Dates\nTo (Mo/Yr)
    ...
    A_III_DateTimeField25_0 = State()  # 170 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField27_0 = State()  # 171 Dates\nTo (Mo/Yr)
    ...
    A_III_DateTimeField28_0 = State()  # 176  # Dates\nFrom (Mo/Yr)
    A_III_DateTimeField29_0 = State()  # 177  # Dates\nTo (Mo/Yr)
    ...
    A_III_DateTimeField30_0 = State()  # 182 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField31_0 = State()  # 183 Dates\nTo (Mo/Yr)
    ...
    A_III_DateTimeField32_0 = State()  # 188 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField33_0 = State()  # 189 Dates\nTo (Mo/Yr)
    ...
    A_III_DateTimeField41_0 = State()  # 193 Attended\nFrom (Mo/Yr)
    A_III_DateTimeField40_0 = State()  # 194  # Attended\nTo (Mo/Yr)
    ...
    A_III_DateTimeField38_0 = State()  # 198 Attended\nFrom (Mo/Yr)
    A_III_DateTimeField39_0 = State()  # 199 Attended\nTo (Mo/Yr)
    ...
    A_III_DateTimeField37_0 = State()  # 203 Attended\nFrom (Mo/Yr)
    A_III_DateTimeField36_0 = State()  # 204  # Attended\nTo (Mo/Yr)
    ...
    A_III_DateTimeField34_0 = State()  # 208 Attended\nFrom (Mo/Yr)
    A_III_DateTimeField35_0 = State()  # 209 Attended\nTo (Mo/Yr)

    A_III_TextField13_40 = State()  # 210 Name and Address of Employer
    A_III_TextField13_42 = State()  # 211 Your Occupation
    A_III_DateTimeField42_0 = State()  # 212 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField44_0 = State()  # 213 Dates\nTo (Mo/Yr)

    A_III_TextField13_41 = State()  # 214  # Name and Address of Employer
    A_III_TextField13_43 = State()  # 215  # Your Occupation
    A_III_DateTimeField43_0 = State()  # 216  # Dates\nFrom (Mo/Yr)
    A_III_DateTimeField45_0 = State()  # 217  # Dates\nTo (Mo/Yr)

    A_III_TextField13_44 = State()  # 218 Name and Address of Employer
    A_III_TextField13_45 = State()  # 219 Your Occupation
    A_III_DateTimeField46_0 = State()  # 220 Dates\nFrom (Mo/Yr)
    A_III_DateTimeField47_0 = State()  # 221 Dates\nTo (Mo/Yr)
    ...
    B_ckboxyn2_1 = State()  # Have you or your family members ever been accused charged arrested detained interrogated convicted and sentenced or imprisoned in any\ncountry other than the United States (including for an immigration law violation)? No
    B_ckboxyn2_0 = State()  # Have you or your family members ever been accused charged arrested detained interrogated convicted and sentenced or imprisoned in any\ncountry other than the United States (including for an immigration law violation)? Yes
    B_PBL2_TextField_0 = State()  # 245  # If \Yes\ explain the circumstances and reasons for the action_

    B_ckboxyn3a_1 = State()  # Have you or your family members ever belonged to or been associated with any organizations or groups in your home country such as but not\nlimited to a political party student group labor union religious organization military or paramilitary group civil patrol guerrilla organization\nethnic group human rights group or the press or media? No
    B_ckboxyn3a_0 = State()  # Have you or your family members ever belonged to or been associated with any organizations or groups in your home country such as but not\nlimited to a political party student group labor union religious organization military or paramilitary group civil patrol guerrilla organization\nethnic group human rights group or the press or media? Yes
    B_PBL3A_TextField_0 = State()  # 246  # If \Yes\ describe for each person the level of participation any leadership or other positions held and the length of time you or your family\nmembers were involved in each organization or activity_
    ...
    B_PBL3B_TextField_0 = State()  # 247  # If \Yes\ describe for each person your or your family members  current level of participation any leadership or other positions currently held\nand the length of time you or your family members have been involved in each organization or group_
    ...
    C_ckboxync1_0 = State()  # Have you your spouse your child(ren) your parents or your siblings ever applied to the U_S_ Government for refugee status asylum or\nwithholding of removal? Yes
    C_ckboxync1_1 = State()  # Have you your spouse your child(ren) your parents or your siblings ever applied to the U_S_ Government for refugee status asylum or\nwithholding of removal? No
    C_PCL1_TextField_0 = State()  # 249 If \Yes\ explain the decision and what happened

    C_ckboxync2a_0 = State()  # After leaving the country from which you are claiming asylum did you or your spouse or child(ren) who are now in the United States travel\nthrough or reside in any other country before entering the United States? Yes
    C_ckboxync2a_1 = State()  # After leaving the country from which you are claiming asylum did you or your spouse or child(ren) who are now in the United States travel\nthrough or reside in any other country before entering the United States? No

    C_ckboxync2b_0 = State()  # After leaving the country from which you are claiming asylum did you or your spouse or child(ren) who are now in the United States travel\nthrough or reside in any other country before entering the United States? Yes
    C_ckboxync2b_1 = State()  # After leaving the country from which you are claiming asylum did you or your spouse or child(ren) who are now in the United States travel\nthrough or reside in any other country before entering the United States? No
    C_PCL2B_TextField_0 = State()  # 250 If \Yes\

    C_ckboxync3_0 = State()  # Have you your spouse or your child(ren) ever ordered incited assisted or otherwise participated in causing harm or suffering to any person\nbecause of his or her race religion nationality membership in a particular social group or belief in a particular political opinion? Yes
    C_ckboxync3_1 = State()  # Have you your spouse or your child(ren) ever ordered incited assisted or otherwise participated in causing harm or suffering to any person\nbecause of his or her race religion nationality membership in a particular social group or belief in a particular political opinion? No
    ...
    C_ckboxync6_0 = State()  # Have you or any member of your family included in the application ever committed any crime and/or been arrested charged convicted or\nsentenced for any crimes in the United States (including for an immigration law violation)? Yes
    C_ckboxync6_1 = State()  # Have you or any member of your family included in the application ever committed any crime and/or been arrested charged convicted or\nsentenced for any crimes in the United States (including for an immigration law violation)? No
    ...
    D_ckboxynd3_0 = State()  # Asylum applicants may be represented by counsel_ Have you been provided with a list of\npersons who may be available to assist you at little or no cost with your asylum claim? Yes
    D_ckboxynd3_1 = State()  # Asylum applicants may be represented by counsel_ Have you been provided with a list of\npersons who may be available to assist you at little or no cost with your asylum claim? No
    ...
    D_CheckBox1_0 = State()  # Select this box if\nForm G-28 is\nattached_
    ...
    Supplement_A_ChildExp5_0 = State()  # 301 Date of last entry into the\nU_S
    ...
    Supplement_A_ChildExpAuth5_0 = State()  # 305  # What is the expiration date of his/her\nauthorized stay
    ...
    Supplement_A_ChildExp6_0 = State()  # 319 Date of last entry into the\nU_S_
    Supplement_A_ChildINum6_0 = State()  # 320 I-94  # Number
    Supplement_A_ChildStatus6_0 = State()  # 321 Status when last admitted\n(Visa type if any)
    Supplement_A_ChildCurrent6_0 = State()  # 322 What is your child s current status?
    Supplement_A_ChildExpAuth6_0 = State()  # 323 What is the expiration date of his/her\nauthorized stay if any? (mm/dd/yyyy)
